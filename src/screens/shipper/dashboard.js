                                        ...
                                        <Card>
                                            <CardBody style={{paddingTop: '0'}}>
                                                <div className="chart-wrapper"
                                                    ...
                                                    {/*        height="100%"*/}
                                                    {/*        width={'100%'}/>*/}
                                                    <div dangerouslySetInnerHTML={{ __html: this.state.mapUrl.map2 }} />
                                                </div>
                                            </CardBody>
                                        </Card>
                                    </Col>
